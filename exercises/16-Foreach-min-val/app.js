...
Cada vez que realices un bucle, compara su valor con el valor de la variable, si el valor del elemento es 
menor, actualiza el valor de la variable auxiliar al valor del elemento.
...
// Your code here
let comparador = Number.MAX_SAFE_INTEGER
let numMin = myArray.forEach(function(item) {
